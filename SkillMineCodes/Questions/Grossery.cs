...
namespace SkillMineCodes.Questions
{
    public class C3
    {
        static void Main(string[] args)
        {
            ...
            list.Add(new Grossery { Product = "Soup", Price = 50, Quantity = 10 });
            list.Add(new Grossery { Product = "Brush", Price = 30, Quantity = 6 });
            list.Add(new Grossery { Product = "Dish", Price = 300, Quantity = 6 });
